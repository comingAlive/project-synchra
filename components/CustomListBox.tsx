...
const CustomListBox = () => (
  <Listbox
    ...
    className="p-0 gap-0 ml-auto divide-y divide-default-300/50 dark:divide-default-100/80 bg-content1 max-w-[270px] overflow-visible shadow-small rounded-medium"
    itemClasses={{
